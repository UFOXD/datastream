...
type PostgreSQLParserListener interface {
	...
	// EnterNulls_distinct is called when entering the nulls_distinct production.
	EnterNulls_distinct(c *Nulls_distinctContext)
	...
	// ExitNulls_distinct is called when exiting the nulls_distinct production.
	ExitNulls_distinct(c *Nulls_distinctContext)
