...
func (v *BaseMySqlParserVisitor) VisitClusteringKeyColumnConstraint(ctx *ClusteringKeyColumnConstraintContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseMySqlParserVisitor) VisitClusteringKeyTableConstraint(ctx *ClusteringKeyTableConstraintContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseMySqlParserVisitor) VisitTableOptionSecondaryEngine(ctx *TableOptionSecondaryEngineContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseMySqlParserVisitor) VisitSequenceTableItem(ctx *SequenceTableItemContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseMySqlParserVisitor) VisitCollectionOption(ctx *CollectionOptionContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseMySqlParserVisitor) VisitSequenceFunctionName(ctx *SequenceFunctionNameContext) interface{} {
	return v.VisitChildren(ctx)
}
