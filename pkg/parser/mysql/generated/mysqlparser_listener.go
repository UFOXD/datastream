...
type MySqlParserListener interface {
	...
	// EnterClusteringKeyColumnConstraint is called when entering the clusteringKeyColumnConstraint production.
	EnterClusteringKeyColumnConstraint(c *ClusteringKeyColumnConstraintContext)
	...
	// EnterClusteringKeyTableConstraint is called when entering the clusteringKeyTableConstraint production.
	EnterClusteringKeyTableConstraint(c *ClusteringKeyTableConstraintContext)
	...
	// EnterTableOptionSecondaryEngine is called when entering the tableOptionSecondaryEngine production.
	EnterTableOptionSecondaryEngine(c *TableOptionSecondaryEngineContext)
	...
	// EnterSequenceTableItem is called when entering the sequenceTableItem production.
	EnterSequenceTableItem(c *SequenceTableItemContext)
	...
	// EnterCollectionOption is called when entering the collectionOption production.
	EnterCollectionOption(c *CollectionOptionContext)
	...
	// EnterSequenceFunctionName is called when entering the sequenceFunctionName production.
	EnterSequenceFunctionName(c *SequenceFunctionNameContext)
	...
	// ExitClusteringKeyColumnConstraint is called when exiting the clusteringKeyColumnConstraint production.
	ExitClusteringKeyColumnConstraint(c *ClusteringKeyColumnConstraintContext)
	...
	// ExitClusteringKeyTableConstraint is called when exiting the clusteringKeyTableConstraint production.
	ExitClusteringKeyTableConstraint(c *ClusteringKeyTableConstraintContext)
	...
	// ExitTableOptionSecondaryEngine is called when exiting the tableOptionSecondaryEngine production.
	ExitTableOptionSecondaryEngine(c *TableOptionSecondaryEngineContext)
	...
	// ExitSequenceTableItem is called when exiting the sequenceTableItem production.
	ExitSequenceTableItem(c *SequenceTableItemContext)
	...
	// ExitCollectionOption is called when exiting the collectionOption production.
	ExitCollectionOption(c *CollectionOptionContext)
	...
	// ExitSequenceFunctionName is called when exiting the sequenceFunctionName production.
	ExitSequenceFunctionName(c *SequenceFunctionNameContext)
