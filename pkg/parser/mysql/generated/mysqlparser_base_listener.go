// Code generated from /Users/peter/Codes/dts/datastream/pkg/parser/grammars/mysql/MySqlParser.g4 by ANTLR 4.13.2. DO NOT EDIT.

package generated // MySqlParser
...
// EnterClusteringKeyColumnConstraint is called when production clusteringKeyColumnConstraint is entered.
func (s *BaseMySqlParserListener) EnterClusteringKeyColumnConstraint(ctx *ClusteringKeyColumnConstraintContext) {
}

// ExitClusteringKeyColumnConstraint is called when production clusteringKeyColumnConstraint is exited.
func (s *BaseMySqlParserListener) ExitClusteringKeyColumnConstraint(ctx *ClusteringKeyColumnConstraintContext) {
}
...
// EnterClusteringKeyTableConstraint is called when production clusteringKeyTableConstraint is entered.
func (s *BaseMySqlParserListener) EnterClusteringKeyTableConstraint(ctx *ClusteringKeyTableConstraintContext) {
}

// ExitClusteringKeyTableConstraint is called when production clusteringKeyTableConstraint is exited.
func (s *BaseMySqlParserListener) ExitClusteringKeyTableConstraint(ctx *ClusteringKeyTableConstraintContext) {
}
...
// EnterTableOptionSecondaryEngine is called when production tableOptionSecondaryEngine is entered.
func (s *BaseMySqlParserListener) EnterTableOptionSecondaryEngine(ctx *TableOptionSecondaryEngineContext) {
}

// ExitTableOptionSecondaryEngine is called when production tableOptionSecondaryEngine is exited.
func (s *BaseMySqlParserListener) ExitTableOptionSecondaryEngine(ctx *TableOptionSecondaryEngineContext) {
}
...
// EnterSequenceTableItem is called when production sequenceTableItem is entered.
func (s *BaseMySqlParserListener) EnterSequenceTableItem(ctx *SequenceTableItemContext) {}

// ExitSequenceTableItem is called when production sequenceTableItem is exited.
func (s *BaseMySqlParserListener) ExitSequenceTableItem(ctx *SequenceTableItemContext) {}
...
func (s *BaseMySqlParserListener) EnterCollectionOption(ctx *CollectionOptionContext) {}

// ExitCollectionOption is called when production collectionOption is exited.
func (s *BaseMySqlParserListener) ExitCollectionOption(ctx *CollectionOptionContext) {}
...
// EnterSequenceFunctionName is called when production sequenceFunctionName is entered.
func (s *BaseMySqlParserListener) EnterSequenceFunctionName(ctx *SequenceFunctionNameContext) {}

// ExitSequenceFunctionName is called when production sequenceFunctionName is exited.
func (s *BaseMySqlParserListener) ExitSequenceFunctionName(ctx *SequenceFunctionNameContext) {}
