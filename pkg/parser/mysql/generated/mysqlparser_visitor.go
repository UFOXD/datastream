...
type MySqlParserVisitor interface {
	...
	// Visit a parse tree produced by MySqlParser#clusteringKeyColumnConstraint.
	VisitClusteringKeyColumnConstraint(ctx *ClusteringKeyColumnConstraintContext) interface{}
	...
	// Visit a parse tree produced by MySqlParser#clusteringKeyTableConstraint.
	VisitClusteringKeyTableConstraint(ctx *ClusteringKeyTableConstraintContext) interface{}
	...
	// Visit a parse tree produced by MySqlParser#tableOptionSecondaryEngine.
	VisitTableOptionSecondaryEngine(ctx *TableOptionSecondaryEngineContext) interface{}
	...
	// Visit a parse tree produced by MySqlParser#sequenceTableItem.
	VisitSequenceTableItem(ctx *SequenceTableItemContext) interface{}
	...
	// Visit a parse tree produced by MySqlParser#collectionOption.
	VisitCollectionOption(ctx *CollectionOptionContext) interface{}
	...
	// Visit a parse tree produced by MySqlParser#sequenceFunctionName.
	VisitSequenceFunctionName(ctx *SequenceFunctionNameContext) interface{}
