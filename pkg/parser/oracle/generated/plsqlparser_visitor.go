...
type PlSqlParserVisitor interface {
	...
	VisitRelational_table_properties(ctx *Relational_table_propertiesContext) interface{}

	// Visit a parse tree produced by PlSqlParser#relational_table_property.
	VisitRelational_table_property(ctx *Relational_table_propertyContext) interface{}
	...
	VisitExternal_table_data_format(ctx *External_table_data_formatContext) interface{}

	// Visit a parse tree produced by PlSqlParser#external_table_transform.
	VisitExternal_table_transform(ctx *External_table_transformContext) interface{}

	// Visit a parse tree produced by PlSqlParser#external_table_field.
	VisitExternal_table_field(ctx *External_table_fieldContext) interface{}

	// Visit a parse tree produced by PlSqlParser#external_table_field_list.
	VisitExternal_table_field_list(ctx *External_table_field_listContext) interface{}

	// Visit a parse tree produced by PlSqlParser#external_table_fields_clause.
	VisitExternal_table_fields_clause(ctx *External_table_fields_clauseContext) interface{}

	// Visit a parse tree produced by PlSqlParser#external_table_position_clause.
	VisitExternal_table_position_clause(ctx *External_table_position_clauseContext) interface{}

	// Visit a parse tree produced by PlSqlParser#external_table_datatype_clause.
	VisitExternal_table_datatype_clause(ctx *External_table_datatype_clauseContext) interface{}

	// Visit a parse tree produced by PlSqlParser#external_table_delimit_clause.
	VisitExternal_table_delimit_clause(ctx *External_table_delimit_clauseContext) interface{}

	// Visit a parse tree produced by PlSqlParser#external_table_trim_clause.
	VisitExternal_table_trim_clause(ctx *External_table_trim_clauseContext) interface{}

	// Visit a parse tree produced by PlSqlParser#external_table_date_format_clause.
	VisitExternal_table_date_format_clause(ctx *External_table_date_format_clauseContext) interface{}

	// Visit a parse tree produced by PlSqlParser#external_table_init_clause.
	VisitExternal_table_init_clause(ctx *External_table_init_clauseContext) interface{}

	// Visit a parse tree produced by PlSqlParser#external_table_condition_clause.
	VisitExternal_table_condition_clause(ctx *External_table_condition_clauseContext) interface{}

	// Visit a parse tree produced by PlSqlParser#external_table_lls_clause.
	VisitExternal_table_lls_clause(ctx *External_table_lls_clauseContext) interface{}

	// Visit a parse tree produced by PlSqlParser#external_table_records.
	VisitExternal_table_records(ctx *External_table_recordsContext) interface{}

	// Visit a parse tree produced by PlSqlParser#external_table_record_options_clause.
	VisitExternal_table_record_options_clause(ctx *External_table_record_options_clauseContext) interface{}

	// Visit a parse tree produced by PlSqlParser#external_table_output_files.
	VisitExternal_table_output_files(ctx *External_table_output_filesContext) interface{}

	// Visit a parse tree produced by PlSqlParser#external_table_fields.
	VisitExternal_table_fields(ctx *External_table_fieldsContext) interface{}

	// Visit a parse tree produced by PlSqlParser#external_table_datapump.
	VisitExternal_table_datapump(ctx *External_table_datapumpContext) interface{}

	// Visit a parse tree produced by PlSqlParser#external_table_hive.
	VisitExternal_table_hive(ctx *External_table_hiveContext) interface{}

	// Visit a parse tree produced by PlSqlParser#external_table_hive_parameter_map.
	VisitExternal_table_hive_parameter_map(ctx *External_table_hive_parameter_mapContext) interface{}

	// Visit a parse tree produced by PlSqlParser#external_table_hive_parameter_map_entry.
	VisitExternal_table_hive_parameter_map_entry(ctx *External_table_hive_parameter_map_entryContext) interface{}

	// Visit a parse tree produced by PlSqlParser#external_table_directory.
	VisitExternal_table_directory(ctx *External_table_directoryContext) interface{}
	...
	VisitWith_factoring_clause(ctx *With_factoring_clauseContext) interface{}
	...
	VisitTable_ref_aux_internal_thre(ctx *Table_ref_aux_internal_threContext) interface{}
	...
	VisitCase_when_part_statement(ctx *Case_when_part_statementContext) interface{}

	// Visit a parse tree produced by PlSqlParser#case_else_part_statement.
	VisitCase_else_part_statement(ctx *Case_else_part_statementContext) interface{}
	...
	VisitSimple_case_expression(ctx *Simple_case_expressionContext) interface{}

	// Visit a parse tree produced by PlSqlParser#searched_case_expression.
	VisitSearched_case_expression(ctx *Searched_case_expressionContext) interface{}

	// Visit a parse tree produced by PlSqlParser#case_when_part_expression.
	VisitCase_when_part_expression(ctx *Case_when_part_expressionContext) interface{}

	// Visit a parse tree produced by PlSqlParser#case_else_part_expression.
	VisitCase_else_part_expression(ctx *Case_else_part_expressionContext) interface{}
	...
	VisitNon_reserved_keywords_in_18c(ctx *Non_reserved_keywords_in_18cContext) interface{}
